...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2024 at 12:40 PM
...
--
-- Constraints for table `admin_complaints`
--
ALTER TABLE `admin_complaints`
  ADD CONSTRAINT `admin_complaints_ibfk_1` FOREIGN KEY (`complaint_id`) REFERENCES `complaints` (`id`),
  ADD CONSTRAINT `admin_complaints_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`admin_id`);
